  ...
  return (
    <section className="relative overflow-hidden py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        <div className="relative bg-gradient-to-br from-purple-600 via-pink-500 to-fuchsia-500 rounded-3xl p-8 md:p-12 shadow-2xl">
          {/* Decorative elements */}
          ...
          <div className="relative z-10">
            ...
            <p className="text-white/90 text-lg mb-8 max-w-xl">
              Join thousands optimizing their existence. Get our curated guide
              with the essential protocols for health, wealth, and aesthetics.
            </p>
