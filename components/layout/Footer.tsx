  ...
  return (
    <footer className="border-t border-gray-200 dark:border-gray-800 py-12 bg-white dark:bg-gray-950">
      <div className="max-w-4xl mx-auto px-6 space-y-8">
        ...
        <div className="flex gap-4 p-4 bg-pink-50 dark:bg-pink-900/10 rounded-xl border border-pink-100 dark:border-pink-900/30">
          <RefreshCw className="w-5 h-5 text-pink-600 dark:text-pink-400 flex-shrink-0 mt-0.5 animate-spin" />
